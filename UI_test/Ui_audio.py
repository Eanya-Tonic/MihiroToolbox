...
class Ui_Audio(object):
    def setupUi(self, Audio):
        ...
        self.SmoothScrollArea = SmoothScrollArea(Audio)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 678, 413))
        self.scrollAreaWidgetContents.setMinimumSize(QtCore.QSize(670, 400))
        self.scrollAreaWidgetContents.setStyleSheet("background-color: rgba(255, 255, 255, 0);")
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.widget = QtWidgets.QWidget(self.scrollAreaWidgetContents)
        self.widget.setGeometry(QtCore.QRect(0, 210, 678, 172))
        self.widget.setObjectName("widget")
        self.ProcessBox = QtWidgets.QVBoxLayout(self.widget)
        self.ProcessBox.setContentsMargins(0, 0, 0, 0)
        self.ProcessBox.setObjectName("ProcessBox")
        self.ProcessTitle = SubtitleLabel(self.widget)
        ...
        self.OptionBox = SimpleCardWidget(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(0, 1, 678, 193))
        self.widget1.setObjectName("widget1")
        self.InnerAudioBox = QtWidgets.QVBoxLayout(self.widget1)
        self.InnerAudioBox.setContentsMargins(0, 0, 0, 0)
        ...
        self.AudioBox.addWidget(self.SmoothScrollArea, 1, 0, 1, 1)
...
from qfluentwidgets import BodyLabel, ComboBox, CompactSpinBox, IndeterminateProgressBar, LargeTitleLabel, LineEdit, PrimaryPushButton, PushButton, SimpleCardWidget, SmoothScrollArea, SubtitleLabel
