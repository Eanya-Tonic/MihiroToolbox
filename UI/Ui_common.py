...
class Ui_Common(object):
    def setupUi(self, Common):
        ...
        self.TimeBox.setContentsMargins(-1, 36, -1, 36)
        ...
        self.TimeNum = SpinBox(self.AudioParmsCard)
        self.TimeNum.setObjectName("TimeNum")
        self.InnerTimeBox.addWidget(self.TimeNum, 1, 0, 1, 1)
        self.TimeLabel_2 = BodyLabel(self.AudioParmsCard)
        self.TimeLabel_2.setObjectName("TimeLabel_2")
        self.InnerTimeBox.addWidget(self.TimeLabel_2, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Common):
        ...
        self.TimeLabel.setText(_translate("Common", "时间"))
        self.TimeLabel_2.setText(_translate("Common", "秒"))
...
from qfluentwidgets import BodyLabel, ComboBox, DoubleSpinBox, LargeTitleLabel, LineEdit, PrimaryPushButton, PushButton, SimpleCardWidget, SpinBox, SubtitleLabel
