...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.FileTitle = SubtitleLabel(self.widget)
        ...
        self.FileTitle_2 = SubtitleLabel(self.widget)
        ...
        self.CardWidget = CardWidget(self.widget)
